...
const popup_logo = document.getElementById('popup-logo');
...
const popup_elements = [
    {
        ...
        svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452 520" class="logo"><path fill="#e34f26" d="M41 460L0 0h451l-41 460-185 52" /><path fill="#ef652a" d="M226 472l149-41 35-394H226" /><path fill="#ecedee" d="M226 208h-75l-5-58h80V94H84l15 171h127zm0 147l-64-17-4-45h-56l7 89 117 32z"/><path fill="#fff" d="M226 265h69l-7 73-62 17v59l115-32 16-174H226zm0-171v56h136l5-56z"/></svg>'
    },
    {
        id: "cat-css",
        title: "CSS",
        p: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nemo eius corporis, voluptatem eaque, quas minima repudiandae laborum cum dolorem doloremque ab modi vel fuga consectetur, sint cumque dicta magni vitae.",
        svg: `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 630 630" class="logo">
    ...
    },
    {
        ...
        p: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nemo eius corporis, voluptatem eaque, quas minima repudiandae laborum cum dolorem doloremque ab modi vel fuga consectetur, sint cumque dicta magni vitae.",
        svg: `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452 520" id="popup-logo">
